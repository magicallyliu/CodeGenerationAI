package com.liuh.codegenerationbackend.ratelimter.aop;
...
public class RateLimitAop {
    ...
    /**
     *  前置拦截 限流AOP
     *  地址: https://redisson.pro/docs/data-and-services/objects/#ratelimiter
     * @param joinPoint 获取调用方法信息(切入点)
     *
     * @param rateLimit 注解参数
     */
    ...
    public void doBefore(JoinPoint joinPoint,  RateLimit rateLimit) {
        ...
        //设置限流器参数, 每个时间窗口允许的请求数和时间窗口 (4: 时间单位)
